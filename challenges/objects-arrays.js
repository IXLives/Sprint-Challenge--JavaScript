...
//const universities = graduates.map(function cb(i){
//  return i.university;
//}).sort(); ^-- I'll learn to read first, one day
...
zooAnimals.forEach( (i) => {animalNames.push(`Name: ${i.animal_name}, Scientific: ${i.scientific_name}.`)
});
...
const lowerCase = []; 
zooAnimals.map( (i) => {lowerCase.push(i.animal_name.toLowerCase());
});
...
*/
const populationTotal = zooAnimals.reduce( (acc, val) => {return acc + val.population;
}, 0);
